...
public class ComplexActivity extends AppCompatActivity {
    ...
    void autoPlay(){
        ...
        try {
            cellID=checkforNextTerm(emptyCells);
        }catch (Exception e){
            e.printStackTrace();
        }
    ...
    int  checkforNextTerm(ArrayList<Integer> empty){
        for(int cellID=1;cellID<10;cellID++){
            if (!(playerOne.contains(cellID) || playerTwo.contains(cellID))){
                empty.add(cellID);
            }
        }
        Log.d("PlayerOne:",Arrays.toString(playerOne.toArray()));
        Log.d("PlayerTwo:",Arrays.toString(playerTwo.toArray()));
        Log.d("Empty:",Arrays.toString(empty.toArray()));

        //Toast.makeText(this, "Empty: "+ Arrays.toString(empty.toArray()), Toast.LENGTH_SHORT).show();
        Random rand = new Random();
        int RandIndex = rand.nextInt(empty.size()-0)+0;


        if (playerTwo.contains(1) && playerTwo.contains(2) && empty.contains(3)){
            return 3;
        }else if (playerTwo.contains(2) && playerTwo.contains(3) && empty.contains(1)){
            return 1;
        }else if (playerTwo.contains(1) && playerTwo.contains(3) && empty.contains(2)){
            return 2;
        }else if (playerTwo.contains(4) && playerTwo.contains(5) && empty.contains(6)){
            return 6;
        }else if (playerTwo.contains(5) && playerTwo.contains(6) && empty.contains(4)){
            return 4;
        }else if (playerTwo.contains(4) && playerTwo.contains(6) && empty.contains(5)){
            return 5;
        }else if (playerTwo.contains(7) && playerTwo.contains(8) && empty.contains(9)){
            return  9;
        }else if (playerTwo.contains(8) && playerTwo.contains(9) && empty.contains(7)){
            return 7;
        }else if (playerTwo.contains(7) && playerTwo.contains(9) && empty.contains(8)){
            return 8;
        }else if (playerTwo.contains(1) && playerTwo.contains(4) && empty.contains(7)){
            return 7;
        }else if (playerTwo.contains(4) && playerTwo.contains(7) && empty.contains(1)){
            return 1;
        }else if (playerTwo.contains(1) && playerTwo.contains(7) && empty.contains(4)){
            return 4;
        }else if (playerTwo.contains(2) && playerTwo.contains(5) && empty.contains(8)){
            return 8;
        }else if (playerTwo.contains(5) && playerTwo.contains(8) && empty.contains(2)){
            return 2;
        }else if (playerTwo.contains(2) && playerTwo.contains(8) && empty.contains(5)){
            return 5;
        }else if (playerTwo.contains(3) && playerTwo.contains(6) && empty.contains(9)){
            return  9;
        }else if (playerTwo.contains(6) && playerTwo.contains(9) && empty.contains(3)){
            return 3;
        }else if (playerTwo.contains(3) && playerTwo.contains(9) && empty.contains(6)){
            return 6;
        }else if (playerTwo.contains(1) && playerTwo.contains(5) && empty.contains(9)) {
            return 9;
        }else if (playerTwo.contains(5) && playerTwo.contains(9) && empty.contains(1)){
            return 1;
        }else if (playerTwo.contains(1) && playerTwo.contains(9) && empty.contains(5)){
            return 5;
        }else if (playerTwo.contains(3) && playerTwo.contains(5) && empty.contains(7)){
            return 7;
        }else if (playerTwo.contains(5) && playerTwo.contains(7) && empty.contains(3)){
            return 3;
        }else if (playerTwo.contains(3) && playerTwo.contains(7) && empty.contains(5)){   //playerOne
            return 5;
        }else if (playerOne.contains(1) && playerOne.contains(2) && !playerTwo.contains(3) && empty.contains(3)) {  //PlayerOne
            return 3;
        }else if (playerOne.contains(2) && playerOne.contains(3) && !playerTwo.contains(1) && empty.contains(1)) {
            return 1;
        }else if (playerOne.contains(1) && playerOne.contains(3) && !playerTwo.contains(2) && empty.contains(2)) {
            return 2;
        }else if (playerOne.contains(4) && playerOne.contains(5) && !playerTwo.contains(6) && empty.contains(6)) {
            return 6;
        }else if (playerOne.contains(5) && playerOne.contains(6) && !playerTwo.contains(4) && empty.contains(4)) {
            return 4;
        }else if (playerOne.contains(4) && playerOne.contains(6) && !playerTwo.contains(5) && empty.contains(5)) {
            return 5;
        }else if (playerOne.contains(7) && playerOne.contains(8) && !playerTwo.contains(9) && empty.contains(9)) {
            return 9;
        }else if (playerOne.contains(8) && playerOne.contains(9) && !playerTwo.contains(7) && empty.contains(7)) {
            return 7;
        }else if (playerOne.contains(7) && playerOne.contains(9) && !playerTwo.contains(8) && empty.contains(8)) {
            return 8;
        }else if (playerOne.contains(1) && playerOne.contains(4) && !playerTwo.contains(7) && empty.contains(7)) {
            return 7;
        }else if (playerOne.contains(4) && playerOne.contains(7) && !playerTwo.contains(1) && empty.contains(1)) {
            return 1;
        }else if (playerOne.contains(1) && playerOne.contains(7) && !playerTwo.contains(4) && empty.contains(4)) {
            return 4;
        }else if (playerOne.contains(2) && playerOne.contains(5) && !playerTwo.contains(8) && empty.contains(8)) {
            return 8;
        }else if (playerOne.contains(5) && playerOne.contains(8) && !playerTwo.contains(2) && empty.contains(2)) {
            return 2;
        }else if (playerOne.contains(2) && playerOne.contains(8) && !playerTwo.contains(5) && empty.contains(5)) {
            return 5;
        }else if (playerOne.contains(3) && playerOne.contains(6) && !playerTwo.contains(9) && empty.contains(9)) {
            return 9;
        }else if (playerOne.contains(6) && playerOne.contains(9) && !playerTwo.contains(3) && empty.contains(3)) {
            return 3;
        }else if (playerOne.contains(3) && playerOne.contains(9) && !playerTwo.contains(6) && empty.contains(6)) {
            return 6;
        }else if (playerOne.contains(1) && playerOne.contains(5) && !playerTwo.contains(9) && empty.contains(9)) {
            return 9;
        }else if (playerOne.contains(5) && playerOne.contains(9) && !playerTwo.contains(1) && empty.contains(1)) {
            return 1;
        }else if (playerOne.contains(1) && playerOne.contains(9) && !playerTwo.contains(5) && empty.contains(5)) {
            return 5;
        }else if (playerOne.contains(3) && playerOne.contains(5) && !playerTwo.contains(7) && empty.contains(7)) {
            return 7;
        }else if (playerOne.contains(5) && playerOne.contains(7) && !playerTwo.contains(3) && empty.contains(3)) {
            return 3;
        }else if (playerOne.contains(3) && playerOne.contains(7) && !playerTwo.contains(5) && empty.contains(5)) { /////
            return 5;
        }else if ((playerOne.contains(1) &&(empty.contains(2) && empty.contains(3) && empty.contains(4) && empty.contains(6) && empty.contains(7) && empty.contains(8)) && empty.contains(9)) ||
                (playerOne.contains(2) &&(empty.contains(1) && empty.contains(3) && empty.contains(4) && empty.contains(6) && empty.contains(7) && empty.contains(8)) && empty.contains(9)) ||
                (playerOne.contains(3) &&(empty.contains(1) && empty.contains(2) && empty.contains(4) && empty.contains(6) && empty.contains(7) && empty.contains(8)) && empty.contains(9)) ||
                (playerOne.contains(4) &&(empty.contains(1) && empty.contains(2) && empty.contains(3) && empty.contains(6) && empty.contains(7) && empty.contains(8)) && empty.contains(9)) ||
                (playerOne.contains(6) &&(empty.contains(1) && empty.contains(2) && empty.contains(3) && empty.contains(4) && empty.contains(7) && empty.contains(8)) && empty.contains(9)) ||
                (playerOne.contains(7) &&(empty.contains(2) && empty.contains(3) && empty.contains(4) && empty.contains(6) && empty.contains(1) && empty.contains(8)) && empty.contains(9)) ||
                (playerOne.contains(8) &&(empty.contains(2) && empty.contains(3) && empty.contains(4) && empty.contains(6) && empty.contains(7) && empty.contains(1)) && empty.contains(9)) ||
                (playerOne.contains(9) &&(empty.contains(2) && empty.contains(3) && empty.contains(4) && empty.contains(6) && empty.contains(7) && empty.contains(8)) && empty.contains(1))){
            return 5;
        }else if (playerOne.contains(5) && empty.contains(3) && !playerTwo.contains(3)){
            return 3;
        }else {
            return empty.get(RandIndex);
        }
        ...
        winOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (GoogleSignIn.comeFromOffline==true){
                    Intent i = new Intent(ComplexActivity.this, GoogleSignIn.class);
                    startActivity(i);
                    finish();
    ...
    private void exitLayout(){
        ...
        final AlertDialog.Builder builder=new AlertDialog.Builder(ComplexActivity.this);
        ...
        yesBtwn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (GoogleSignIn.comeFromOffline==true){
                    ...
                    Intent i = new Intent(ComplexActivity.this, MenuActivity.class);
                    startActivity(i);
                    finish();
                }
            }
